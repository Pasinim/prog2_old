...
public class IntSetRepok {
    ...
    /**
     * AF:          (ArrayList) --> {} se l'insieme è vuoto
     *                              {elements(0), elements(1), ... , elements(elements.size-1)}
     *                              Se Exist i t.c. elements(i) == elements(new) allora new non viene aggiunto
     *                                  -> {3, 4, 5}, insert(3) -> {3,4,5}
     * IR                           elements non null
     *                              elementi non duplicati (come implemento?)
     */
